...
extension W3C_XML.Parse {
    ...
    public struct Whitespace<Input: Parsing.Input>: Parsing.Parser, Sendable
    ...
    public struct RequiredWhitespace<Input: Parsing.Input>: Parsing.Parser, Sendable
    where Input: Sendable, Input.Element == UInt8 {
        public typealias Output = Void
...
extension W3C_XML.Parse {
    ...
    public struct Name<Input: Parsing.Input>: Parsing.Parser, Sendable
    where Input: Sendable, Input.Element == UInt8 {
...
extension W3C_XML.Parse {
    ...
    public struct Reference<Input: Parsing.Input>: Parsing.Parser, Sendable
    where Input: Sendable, Input.Element == UInt8 {
